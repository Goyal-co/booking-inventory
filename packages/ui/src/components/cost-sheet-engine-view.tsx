  ...
  const inventoryRows: Array<[string, string]> =
    costSheet.partAItems && costSheet.partAItems.length > 0
      ...
      : [
          ...
          ["Floors", floorLabel],
          ["Super built-up Area (SBA) (Sq.ft.)", fmtNum(costSheet.saleableAreaSqft)],
          ...
          ["Unit Price per sq.ft. on Super built-up Area (SBA) (Rs.)", formatPrice(costSheet.saleablePricePerSqft)],
